...
namespace jlinkdev.UnityUtilities.VolumetricFogAndRain.Editor
{
    ...
    {
        [MenuItem("Tools/jlinkdev/Volumetric Fog and Rain/Add Feature to Selected Renderer")]
        ...
        [MenuItem("Tools/jlinkdev/Volumetric Fog and Rain/Create Rain Laboratory")]
        public static void CreateLaboratory() => CreateLaboratory(false);

        [MenuItem("Tools/jlinkdev/Volumetric Fog and Rain/Create Volume Laboratory")]
        public static void CreateVolumeLaboratory() => CreateLaboratory(true);

        [MenuItem("Tools/jlinkdev/Volumetric Fog and Rain/Create Fog Laboratory")]
        ...
        private static void CreateLaboratory(bool withVolumes, bool fogOnly = false)
        {
            ...
            const string root = "Assets/VolumetricFogAndRain";
            if (!AssetDatabase.IsValidFolder(root)) AssetDatabase.CreateFolder("Assets", "VolumetricFogAndRain");
            ...
            if (fogOnly)
            {
                ...
                profile.fogHeightFalloff = .15f;
                profile.fogNoiseVelocity = new Vector3(.2f, 0, .1f);
                profile.directionalScattering = .15f;
            }
            ...
            if (withVolumes)
            {
                ...
                if (fogOnly) wet.featherDistance = 2;
                ...
                if (fogOnly) dry.featherDistance = .75f;
