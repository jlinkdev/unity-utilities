...
namespace jlinkdev.UnityUtilities.VolumetricRain.Development
{
    ...
    public static class RainBuildValidation
    {
        ...
        {
            const string root = "Assets/PackageDevelopment/VolumetricRain/SampleAuthoring/Rain Laboratory/";
